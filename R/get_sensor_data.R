#' Get all the data related to one sensor connected to your account
#'
#' Get all the data related to one sensor connected to your account
...
#' @return Returns a Dataframe with the data related to one sensor connected to your account
#' @export
get_sensor_data<-function(id_sensor,
                          token) {
