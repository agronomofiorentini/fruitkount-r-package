#' Retrieve the html widget graph related to a specific sensor on a selected acquisition date
#'
#' Retrieve all data collected by a specific sensor on a selected acquisition date,
#' save an HTML copy locally and optionally open it in the browser.
...
#' @export
get_html_graph <- function(id_sensor,
                           date,
                           variable,
                           token,
                           save_dir = ".",
