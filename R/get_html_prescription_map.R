#' Retrieve the html widget leaflet map with the prescription map related to a specific sensor on a selected acquisition date
#'
#' Retrieve the html widget leaflet map with the prescription map related to a specific sensor on a selected acquisition date
...
#' @param filename Filename where the html will be saved
...
#' @export
get_html_prescription_map <- function(id_sensor,
                                      date,
                                      automatic,
                                      zone,
                                      fertilizer,
